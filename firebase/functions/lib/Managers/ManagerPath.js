...
class ManagerPath {
    ...
    getPathToServerFunctionsFakeUsers() {
        return ManagerPathSeperator_1.managerPathSeperator.addSlashBetweenPaths([this.serverFunctions, this.serverFunctionsAddFakeUsers]);
    }
